...
//Tony, this is the parent side of your invoice page. please change the name to invoice as we dont use payment directly, parents only received invoice. i commented my stuff below but if you need some references for import and other stuff. you can check that and also the invoiceview.js from components. if you made any changes to other files, please add comments so we know whats going on to prevent conflicts when merging.
